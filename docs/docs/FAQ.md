...
??? question "What are the best models for nortex.diy?"
For the best experience with nortex.diy, we recommend using the following models from our 19 supported providers:
...
nortex.diy uses a modular provider architecture. To add a new provider:
...
nortex.diy provides multiple ways to access help and documentation:
...
??? question "How do I get the best results with nortex.diy?"
...
MCP extends nortex.diy's AI capabilities with external tools:
...
??? question "How do I deploy my nortex.diy projects?"
nortex.diy supports one-click deployment to multiple platforms:
...
nortex.diy provides comprehensive Git and GitHub integration:
...
??? question "How do I contribute to nortex.diy?"
Check out our [Contribution Guide](CONTRIBUTING.md) for more details on how to get involved!

??? question "What are the future plans for nortex.diy?"
Visit our [Roadmap](https://roadmap.sh/r/ottodev-roadmap-2ovzo) for the latest updates.  
 New features and improvements are on the way!

??? question "Why are there so many open issues/pull requests?"
nortex.diy began as a small showcase project on @ColeMedin's YouTube channel to explore editing open-source projects with local LLMs. However, it quickly grew into a massive community effort!

    We're forming a team of maintainers to manage demand and streamline issue resolution. The maintainers are rockstars, and we're also exploring partnerships to help the project thrive.

## New Features & Technologies

??? question "What's new in nortex.diy?"
Recent major additions to nortex.diy include:
...
nortex.diy offers templates for popular frameworks and technologies:
...
??? question "How do local LLMs compare to larger models like Claude 3.5 Sonnet for nortex.diy?"
...
If you're having trouble with MCP integrations:
    ...
    - **Test server connectivity** outside of nortex.diy
...
**Windows development environment**: Install Visual Studio C++ (version 14.40.33816 or later). More details in [GitHub Issues](https://github.com/stackblitz-labs/nortex.diy/issues/19)
...
[Join the nortex.diy Community](https://thinktank.ottomator.ai/c/nortex-diy/17){target=\_blank} for discussions and help

!!! bug "Report Issues"
[Open an Issue](https://github.com/stackblitz-labs/nortex.diy/issues/19){target=\_blank} in our GitHub Repository
