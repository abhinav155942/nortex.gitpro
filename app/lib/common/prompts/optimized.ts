...
<artifact_info>
  ...
  - Use \`<nortexArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<nortexAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<nortexArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<nortexAction>\` tags with appropriate \`type\` attribute:
