...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out nortex artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <nortex', 'Foo bar '],
      ['Foo bar <nortexa', 'Foo bar <nortexa'],
      ['Foo bar <nortexA', 'Foo bar '],
      ['Foo bar <nortexArtifacs></nortexArtifact>', 'Foo bar <nortexArtifacs></nortexArtifact>'],
      ['Before <oltArtfiact>foo</nortexArtifact> After', 'Before <oltArtfiact>foo</nortexArtifact> After'],
      ['Before <nortexArtifactt>foo</nortexArtifact> After', 'Before <nortexArtifactt>foo</nortexArtifact> After'],
    ])('should correctly parse chunks and strip out nortex artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <nortexArtifact title="Some title" id="artifact_1">foo bar</nortexArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <nortexArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</nortexArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</nortexArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</nortexArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <nortexArtifact title="Some title" id="artifact_1">foo</nortexArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <nortexArtifact title="Some title" id="artifact_1"><nortexAction type="shell">npm install</nortexAction></nortexArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <nortexArtifact title="Some title" id="artifact_1"><nortexAction type="shell">npm install</nortexAction><nortexAction type="file" filePath="index.js">some content</nortexAction></nortexArtifact> After',
        {
          output: 'Before  After',
