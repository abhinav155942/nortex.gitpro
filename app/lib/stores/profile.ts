...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('nortex_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('nortex_profile', JSON.stringify(profileStore.get()));
  }
};
