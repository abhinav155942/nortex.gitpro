    ...
    return (
      <div className="flex items-center gap-2">
        <Popover className="relative">
          {({ open }: { open: boolean }) => (
            <>
              <Popover.Button className="flex items-center gap-2 px-3 py-1.5 text-sm rounded-lg bg-nortex-elements-background-depth-2 hover:bg-nortex-elements-background-depth-3 transition-colors text-nortex-elements-item-contentDefault">
              ...
              >
                <Popover.Panel className="absolute right-0 z-20 mt-2 w-80 origin-top-right rounded-xl bg-nortex-elements-background-depth-2 shadow-xl border border-nortex-elements-borderColor">
                  <div className="p-2">
                    <div className="relative mx-2 mb-2">
                      <input
                        ...
                        className="w-full pl-8 pr-3 py-1.5 text-sm rounded-lg bg-nortex-elements-background-depth-1 border border-nortex-elements-borderColor focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                      />
                      <div className="absolute left-2 top-1/2 -translate-y-1/2 text-nortex-elements-textTertiary">
                    ...
                    <div className="max-h-60 overflow-y-auto">
                      {filteredFiles.length > 0 ? (
                        filteredFiles.map(([filePath, history]) => {
                          ...
                          return (
                            <button
                              ...
                              className="w-full px-3 py-2 text-left rounded-md hover:bg-nortex-elements-background-depth-1 transition-colors group bg-transparent"
                            >
                              <div className="flex items-center gap-2">
                                <div className="shrink-0 w-5 h-5 text-nortex-elements-textTertiary">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center justify-between gap-2">
                                    <div className="flex flex-col min-w-0">
                                      <span className="truncate text-sm font-medium text-nortex-elements-textPrimary">
                                        {filePath.split('/').pop()}
                                      </span>
                                      <span className="truncate text-xs text-nortex-elements-textTertiary">
                                        {filePath}
                                      </span>
                                    </div>
                                    {(() => {
                        ...
                        <div className="flex flex-col items-center justify-center p-4 text-center">
                          <div className="w-12 h-12 mb-2 text-nortex-elements-textTertiary">
                            <div className="i-ph:file-dashed" />
                          </div>
                          <p className="text-sm font-medium text-nortex-elements-textPrimary">
                            {searchQuery ? 'No matching files' : 'No modified files'}
                          </p>
                          <p className="text-xs text-nortex-elements-textTertiary mt-1">
                  ...
                  {hasChanges && (
                    <div className="border-t border-nortex-elements-borderColor p-2">
                      <button
                        onClick={() => {
                        ...
                        className="w-full flex items-center justify-center gap-2 px-3 py-1.5 text-sm rounded-lg bg-nortex-elements-background-depth-1 hover:bg-nortex-elements-background-depth-3 transition-colors text-nortex-elements-textTertiary hover:text-nortex-elements-textPrimary"
                      >
                        Copy File List
                      </button>
                    </div>
