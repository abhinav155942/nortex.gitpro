      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-nortex-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-nortex-elements-item-backgroundAccent hover:bg-nortex-elements-artifacts-backgroundHover"
