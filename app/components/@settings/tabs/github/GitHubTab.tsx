    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GithubLogo />
          <h2 className="text-lg font-medium text-nortex-elements-textPrimary">GitHub Integration</h2>
        </div>
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            {connection?.rateLimit && (
              <div className="flex items-center gap-2 px-3 py-1 bg-nortex-elements-background-depth-1 rounded-lg text-xs">
                <div className="i-ph:cloud w-4 h-4 text-nortex-elements-textSecondary" />
                <span className="text-nortex-elements-textSecondary">
        ...
        {stats?.repos && stats.repos.length > 0 && (
          <motion.div
            ...
            className="border-t border-nortex-elements-borderColor pt-6"
          >
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-nortex-elements-background dark:bg-nortex-elements-background-depth-2 border border-nortex-elements-borderColor dark:border-nortex-elements-borderColor hover:border-nortex-elements-borderColorActive/70 dark:hover:border-nortex-elements-borderColorActive/70 transition-all duration-200">
                  ...
                  <ChevronDown
                    className={classNames(
                      'w-4 h-4 transform transition-transform duration-200 text-nortex-elements-textSecondary',
                  ...
                  {stats.repos.length > 12 && !isReposExpanded && (
                    <div className="text-center">
                      <Button
                        ...
                        className="text-nortex-elements-textSecondary hover:text-nortex-elements-textPrimary"
                      >
        ...
        {isConnected && connection && (
          <div className="mt-8 pt-6 border-t border-nortex-elements-borderColor">
