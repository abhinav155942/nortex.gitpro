  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-nortex-elements-borderColor bg-nortex-elements-background-depth-1 text-nortex-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-nortex-elements-textSecondary', className)} {...props} />;
  },
);
