      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-nortex-elements-textPrimary dark:text-nortex-elements-textPrimary-dark'
              : 'text-nortex-elements-textSecondary dark:text-nortex-elements-textSecondary-dark hover:text-nortex-elements-textPrimary dark:hover:text-nortex-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-nortex-elements-textTertiary dark:text-nortex-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
