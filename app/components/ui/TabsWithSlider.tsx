        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-nortex-elements-background-depth-2 dark:bg-nortex-elements-background-depth-3 text-nortex-elements-textPrimary dark:text-nortex-elements-textPrimary-dark hover:bg-nortex-elements-background-depth-3 dark:hover:bg-nortex-elements-background-depth-4 border border-nortex-elements-borderColor dark:border-nortex-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
