...
export const MODIFICATIONS_TAG_NAME = 'nortex_file_modifications';
...
export const STARTER_TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    githubRepo: 'xKevIsDev/nortex-expo-template',
  ...
  },
  {
    ...
    icon: 'i-nortex:shadcn',
  },
  {
    name: 'Qwik Typescript',
    label: 'Qwik TypeScript',
    description: 'Qwik framework starter with TypeScript for building resumable applications',
    githubRepo: 'xKevIsDev/nortex-qwik-ts-template',
  ...
  },
  {
    ...
    githubRepo: 'xKevIsDev/nortex-remix-ts-template',
  ...
  },
  {
    ...
    githubRepo: 'xKevIsDev/nortex-slidev-template',
    tags: ['slidev', 'presentation', 'markdown'],
    icon: 'i-nortex:slidev',
  },
  {
    name: 'Sveltekit',
    label: 'SvelteKit',
    description: 'SvelteKit starter template for building fast, efficient web applications',
    githubRepo: 'nortex-sveltekit-template',
    tags: ['svelte', 'sveltekit', 'typescript'],
    icon: 'i-nortex:svelte',
  },
  {
    name: 'Vanilla Vite',
    label: 'Vanilla + Vite',
  ...
  },
  {
    ...
    githubRepo: 'xKevIsDev/nortex-vite-react-ts-template',
  ...
  },
  {
    ...
    githubRepo: 'xKevIsDev/nortex-vite-ts-template',
    tags: ['vite', 'typescript', 'minimal'],
    icon: 'i-nortex:typescript',
  },
  {
    name: 'Vue',
    label: 'Vue.js',
    description: 'Vue.js starter template with modern tooling and best practices',
    githubRepo: 'xKevIsDev/nortex-vue-template',
  ...
  },
  {
    ...
    githubRepo: 'xKevIsDev/nortex-angular-template',
    tags: ['angular', 'typescript', 'frontend', 'spa'],
    icon: 'i-nortex:angular',
  },
  {
    name: 'SolidJS',
